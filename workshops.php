                        ...
                        <div class="tab-pane fade show active" id="step-one" role="tabpanel" aria-labelledby="monday-tab">
                            ...
                            <div class="single-tab-content">
                                <div class="row">
                                    <div class="col-12">
                                        <?
                                            $result=$con->query("SELECT * FROM `workshop` where workshop_status=1 ORDER BY `workshop_id` ASC");  
                                            $j=1;
                                        ...
                                        <div class="single-schedule-area single-page d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                                            ...
                                            <div class="single-schedule-tumb-info d-flex align-items-center">
                                                ...
                                                <div class="single-schedule-tumb" style="height: 140px;">
                                                    <img src="admin/uploads/workshop/<?=$row['workshop_image']?>" alt="">
                                                </div>
                                                <!-- Single Schedule Info -->
                                                <div class="single-schedule-info">
                                                    <h6><?=$row['workshop_name']?></h6>
                                                    <p><?=$row['workshop_info']?></p>
                                                </div>
                                            </div>
                                            <!-- Single Schedule Info -->
                                            <div class="schedule-time-place">
                                                <p><span>₹</span> <?=$row['workshop_price']?></p> 
                                            </div>
                                            <!-- Schedule Btn -->
                                            <? 
                                            $proj = $row['workshop_price'];  
                                            $pj=md5($proj); 
                                            $na = $row['workshop_name'];
                                            $naam = md5($na);
                                            ?>
                                            <a href="pay1.php?name=<?=$naam?>&type=workshop&wage=<?=$pj?>" class="btn confer-btn">Pay<i class="zmdi zmdi-long-arrow-right"></i></a>
                                        </div>
                                        <? } ?> 
                                    </div> 
                                </div>
